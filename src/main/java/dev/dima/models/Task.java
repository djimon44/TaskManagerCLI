...
// Task,java creates a model for a task in the task manager application
public class Task {
    public static int id = 0; /** Used as a global counter in the Linked List **/
    private int taskId;
    ...
    /** Constructor for JSON serialization and deserialization with Jackson **/
    /** Assigns fields to JSON properties **/
    @JsonCreator
    ...
    /** Custom toString, equals and hashCode methods to cover specifics **/
    @Override
